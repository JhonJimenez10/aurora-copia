...
export default function AirlineManifestReport({
    ...
    const [filtered, setFiltered] = useState(rows.length > 0); // si ya hay datos cargados
    ...
    const handleFilter = () => {
        ...
        router.get(
            ...
            {
                preserveState: true,
                onSuccess: () => setFiltered(true), // activamos el botón Exportar
            }
        );
    };
