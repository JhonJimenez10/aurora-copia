...
export default function RecipientsIndex({ recipients }: PageProps<{ recipients: Recipient[] }>) {
    ...
    <AuthenticatedLayout>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-6 py-4 rounded-t-lg">
          <h1 className="text-2xl font-bold">Clientes Destinatario</h1>
          <p className="text-purple-100 text-sm">Gestión de destinatarios registrados</p>
        </div>
            ...
            <table className="min-w-full text-sm text-white table-auto">
              ...
              <tbody>
                {recipients.map((recipient) => (
                  <tr key={recipient.id} className="border-t border-slate-700 hover:bg-slate-800">
                    <td className="px-4 py-2">{recipient.full_name}</td>
                    <td className="px-4 py-2">{recipient.identification}</td>
