...
<head>
    ...
    <style>
        @page {
            size: 74mm 280mm;  /* ticket térmico */
            margin: 5mm;
        }
        body { font-family: Arial, sans-serif; font-size: 10px; margin: 0; text-align: center; }
        ...
        .signature { margin-top: 12px; display: flex; justify-content: space-between; text-align: center; }
...
@for($i=0; $i < $totalCopies; $i++)
  ...
  <div class="container">
      ...
      <div class="section left-align" style="font-size: 10px; margin-top: 4px;">
          ...
          <div><span class="bold">Fecha:</span> {{ \Carbon\Carbon::parse($invoice->issue_date)->format('d M Y H:i:s') }}</div>
      </div>
      ...
      <div class="section left-align" style="font-size: 10px;">
          <table style="width: 100%; font-family: Arial, sans-serif;">
              <colgroup>
                  <col style="width: 22%;"><col style="width: 56%;"><col style="width: 22%;">
              </colgroup>
              <thead>
                  <tr>
      ...
      <div class="section left-align" style="font-size: 8px; line-height: 1.2; margin-top: 8px;">
          ...
          <div style="margin-bottom: 0;">
              <span class="bold">EL OPERADOR POSTAL</span>, indemnizará al Usuario, en caso de daño, pérdida, robo, hurto, explotación o avería y el retraso no justificado, aplicando lo dispuesto en el Reglamento de Títulos Habilitantes y de la Gestión del Sector Postal.
          </div>
          <div style="margin-bottom: 0;">
              <span class="bold">EL OPERADOR POSTAL</span> declara que los datos de los clientes se encuentran protegidos por la Ley, salvo pedido expreso de autoridad competente.
          </div>
          <div style="margin-bottom: 0;">
              <span class="bold">EL REMITENTE</span> podrá recuperar envíos no entregados; cumplido el tiempo de custodia, el operador podrá disponer de ellos como rezagados.
          </div>
          <div style="margin-bottom: 0;">
              <span class="bold">EL USUARIO</span> podrá presentar reclamos y sugerencias a través del portal institucional.
          </div>
      </div>
